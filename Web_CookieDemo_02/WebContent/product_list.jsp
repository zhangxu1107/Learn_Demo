...
<%@page import="cn.zx.util.CookieUtil"%>
...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=1"> <img
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=2"> <img
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=3"> <img
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=4"> <img
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=5"> <img
				src="products/1/cs10005.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=6"> <img
				src="products/1/cs10006.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
		...
		<div class="col-md-2">
			<a href="ProductInfoServlet?id=7"> <img
				src="products/1/cs10007.jpg" width="170" height="170"
				style="display: inline-block;">
			</a>
			<p>
	...
	<div
		...
		<a href="CleanHistory"><h2>清除浏览记录</h2></a>
	</div>
